      ...
      <button
        ...
        className={`group flex w-full items-center border border-dashed border-stroke-hi bg-transparent text-left text-text-secondary transition-all duration-300 hover:border-brand hover:bg-glass hover:text-text-primary ${
          isList
            ...
            : "min-h-[150px] flex-col justify-center gap-[10px] rounded-[18px] p-5 text-center hover:-translate-y-[3px]"
        }`}
      >
        <span
          className={`grid shrink-0 place-items-center rounded-[13px] border border-stroke bg-glass-2 text-text-tertiary transition-all duration-300 group-hover:border-brand group-hover:text-brand group-hover:shadow-[0_0_18px_-4px_var(--glow)] ${
